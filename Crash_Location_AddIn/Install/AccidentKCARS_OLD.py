...
@author: kyleg
DAT -    Changed gdb target on 2015-04-24 for testing.
'''
...
def PathReSet():
    ...
    try:
        ...
        #gdb = r'C:\GIS\Geodatabases\Region1_CL_Final.gdb'
        gdb = r'\\gisdata\arcgis\GISdata\DASC\NG911\Final\Region1_CL_Final.gdb'
